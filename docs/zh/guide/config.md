...
![](../../static/imgs/config2.webp)

## 右上角菜单

点击右上角移动端图标可以进入移动端打包页面，可以打包安卓和 ios 手机 APP。右侧的菜单可以删除项目或者进入功能演示等页面。

![](../../static/imgs/delete.webp)
...
3. APP 标识：也就是 APP ID 是用来区分你的软件的，不能与其他项目重复，要复合规范：仅允许小写字母、数字、下划线，段不能以数字开头，无连续点 / 首尾点 。
