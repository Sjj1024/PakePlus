        ...
        <div id="article_content" class="article_content clearfix">
            ...
            <div id="content_views" class="htmledit_views">
                <p style="text-align: center">
                    <img alt="" src="./static/imgs/pakeplus.png" width="197" />
                </p>
                <p>
                    PakePlus是一个开源免费的软件，支持 Mac、Windows 和
                ...
                <p>
                    - 👻 PakePlus 只是一个简单的工具——用 Tauri
                    替代旧的打包方式（虽然 PWA 也够用了）。
                </p>
                <p>
                    - 🤗 PakePlus 易于使用，只需一个 GitHub
                    Token，即可获得桌面应用。
                </p>
                <p>
                ...
                <p>只需要勾选下面的权限就可以了：repo 和 workflow</p>
                <p>
                    <img
                        alt=""
                ...
                <p>然后将得到的token复制到PakePlus就可以了：</p>
                <p>
                    <img
                        alt=""
