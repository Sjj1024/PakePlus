                    ...
                    b.exports = function (b, c) {
                        function d() {
                            if (
                                ...
                                !('file:' === window.location.protocol && 'ActiveXObject' in window)
                            )
                ...
                function (a, b, c) {
                    ...
                    b.exports = function (b, c) {
                        ...
                        a('./image-size')(n.environment),
                            c.functions && n.functions.functionRegistry.addMultiple(c.functions);
                        var t = /^text\/(x-)?less$/;
                        return (
                            (n.watch = function () {
                                return (
                ...
                function (a, b, c) {
                    ...
                    (d.Eval = function (a, b) {
                        ...
                        (d.Eval.prototype.isMathOn = function () {
                            return (
                                !this.strictMath || (this.parensStack && this.parensStack.length)
                            );
                        }),
                        ...
                        e = function (a, b) {
                            ...
                            for (
                                ...
                                h
                                    ? (this[g] = h.bind(a))
                                    : f < d.length &&
                                      this.warn('missing required function in environment - ' + g);
                            }
                        };
                ...
                function (a, b, c) {
                    ...
                    (h = {
                        ...
                        contrast: function (a, b, c, d) {
                            ...
                            return (
                                (d = 'undefined' == typeof d ? 0.43 : f(d)), a.luma() < d ? c : b
                            );
                        },
                        argb: function (a) {
                                ...
                                parsers: (n = {
                                    ...
                                    extend: function (a) {
                                        ...
                                        if (o.$str(a ? '&:extend(' : ':extend(')) {
                                            do {
                                                ...
                                                (f = f && f[1]),
                                                    b ||
                                                        i('Missing target selector for :extend().'),
                                            ...
                                            if (
                                                ...
                                                if (
                                                    ...
                                                    if (
                                                        ...
                                                        return (
                                                            o.forget(),
                                                            new e.mixin.Definition(a, f, c, d, g)
                                                        );
                                                    o.restore();
                                                } else o.forget();
                                        },
                                    ...
                                    rule: function (b) {
                                        ...
                                        if ('.' !== k && '#' !== k && '&' !== k && ':' !== k)
                                            if (
                                                (o.save(),
                                                (d = this.variable() || this.ruleProperty()))
                                            ) {
                                                if (
                                                    ((i = 'string' == typeof d),
                                        ...
                                        if (d) {
                                            ...
                                            if ((a = this.entities.quoted() || this.entities.url()))
                                                return (
                                                    o.$char(';') ||
                                                        ((o.i = b),
                                                        i('missing semi-colon on plugin')),
            ...
            52: [
                function (a, b, c) {
                    ...
                    (f.prototype = new d()),
                        ...
                        (f.prototype.genCSS = function (a, b) {
                            this.debugInfo && b.add(e(a, this), this.currentFileInfo, this.index),
                                b.add(this.value);
                        }),
                    ...
                    (h.prototype = new e()),
                        ...
                        (h.prototype.eval = function (a) {
                            var b,
                                ...
                                f = this.variable;
                            'string' != typeof e &&
                                ((e = 1 === e.length && e[0] instanceof g ? e[0].value : d(a, e)),
                                (f = !1)),
                    ...
                    (f.prototype = new d()),
                        ...
                        (f.prototype.match = function (a) {
                            var b,
                                ...
                                d = this.elements,
                                e = d.length;
                            if ((a.CacheElements(), (b = a._elements.length), 0 === b || e < b))
                                return 0;
                        ...
                        (d.prototype.visit = function (a) {
                            return a
                                ? a.constructor === Array
                                    ...
                                    ? a
                                    : (this.visible ? a.ensureVisibility() : a.ensureInvisibility(),
                                      a.accept(this),
                                      a)
                                : a;
                        }),
