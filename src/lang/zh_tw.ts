export default {
    ...
    delSuccess: '刪除成功',
    aboutGuide:
        'PakePlus開源免費，Web網頁打包跨平台APP，僅僅只需要一個Github Token，就可以將你的網頁或Vue/React等項目打包成一個獨立可執行程序，支持Windows,macOS, Linux系統，還支持Android,iOS移動端。有問題可以加我微信：lanxingme，備註：PakePlus，或者給我發送郵件: 1024xiaoshen@gmail.com',
    moreConfig: '更多配置',
    superpower: '能力演示',
    scriptFile: '腳本文件',
